...
import disclaimerHeroImg from "@/assets/disclaimer-hero.jpg";
  ...
  return (
    <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0">
        <img
          src={disclaimerHeroImg}
          alt="USIN Foundation legal and compliance team"
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center py-32">
        ...
        >
          Important information regarding the use of our website, services, and content published by USIN Foundation.
        </motion.p>
      </div>
    </section>
  );
