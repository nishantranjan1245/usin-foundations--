...
import { TreePine, Heart, Phone } from "lucide-react";
import { Link } from "react-router-dom";

const TreePlantationCTA = () => {
  return (
    <section className="py-20 bg-secondary/30">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <TreePine className="w-12 h-12 text-accent mx-auto mb-6" />
          <h2 className="font-display text-3xl sm:text-4xl font-bold text-foreground mb-6 leading-tight">
            Be a Part of India's{" "}
            <span className="text-accent">Green Revolution</span>
          </h2>
          <p className="text-muted-foreground font-body mb-10 max-w-xl mx-auto leading-relaxed">
            Whether you volunteer your time, sponsor a tree, or donate to our 
            nurseries — every action counts. Together, we can restore India's 
            forests and secure a sustainable future.
          </p>
...
export default TreePlantationCTA;
