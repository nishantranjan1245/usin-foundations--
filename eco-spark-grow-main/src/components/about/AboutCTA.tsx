  ...
  return (
    <section className="relative py-24 lg:py-32 overflow-hidden" ref={ref}>
      <div className="absolute inset-0">
        <img
          src={banyanTree}
          alt="A majestic banyan tree with sprawling roots"
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          <p className="text-lg text-primary-foreground/80 mb-10">
            Join thousands of changemakers who are already building 
            a greener India. Plant a tree, volunteer, or donate — 
            every action counts.
          </p>
