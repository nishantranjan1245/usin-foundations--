...
import refundHeroImg from "@/assets/refund-hero.jpg";
  ...
  return (
    <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0">
        <img
          src={refundHeroImg}
          alt="USIN Foundation team reviewing financial documents"
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center py-32">
        ...
        >
          Our commitment to fair, transparent handling of donations and contributions at USIN Foundation.
        </motion.p>
      </div>
    </section>
  );
