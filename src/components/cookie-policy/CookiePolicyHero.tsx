...
import cookieHeroImg from "@/assets/cookie-policy-hero.jpg";
  ...
  return (
    <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0">
        <img
          src={cookieHeroImg}
          alt="USIN Foundation cookie policy and data transparency"
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center py-32">
        ...
        >
          Learn how USIN Foundation uses cookies to enhance your browsing experience and protect your privacy.
        </motion.p>
      </div>
    </section>
  );
