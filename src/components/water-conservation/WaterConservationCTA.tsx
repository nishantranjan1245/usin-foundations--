...
import { Droplets, Heart, Phone } from "lucide-react";
import { Link } from "react-router-dom";

const WaterConservationCTA = () => {
  return (
    <section className="py-20 bg-secondary/30">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <Droplets className="w-12 h-12 text-accent mx-auto mb-6" />
          <h2 className="font-display text-3xl sm:text-4xl font-bold text-foreground mb-6 leading-tight">
            Help Us Save India's{" "}
            <span className="text-accent">Water Future</span>
          </h2>
          <p className="text-muted-foreground font-body mb-10 max-w-xl mx-auto leading-relaxed">
            Whether you fund a check dam, volunteer in a desilting drive, or 
            spread awareness — every effort matters. Together, we can ensure 
            no village goes thirsty.
          </p>
...
export default WaterConservationCTA;
